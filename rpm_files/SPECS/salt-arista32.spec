...
%description
Self contained Python 3.9 Salt Minion 32-bit binary
...
- Update for Arista 32-bit native minion for point release Salt %{version}

* Mon Aug 17 2020 SaltStack Packaging Team <packaging@saltstack.com> - 3001.1
- Update for Arista 32-bit native minion for point release Salt 3001.1
